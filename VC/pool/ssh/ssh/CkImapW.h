...
class CkImapW  : public CkWideCharBase
{
	...
	// "\Seen", "\Answered", "\Flagged", "\Draft", and "\Answered" may be set. Custom
	// flags such as "NonJunk", "$label1", "$MailFlagBit1", etc. may also be set.
	// 
	...
	// flags such as "\Seen", "\Answered", "\Flagged", "\Draft", and "\Answered" may be
