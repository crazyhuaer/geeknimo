...
HCkFtp2W CkFtp2W_Create2(BOOL bCallbackOwned);
...
void CkFtp2W_getAsyncLog(HCkFtp2W cHandle, HCkString retval);
const wchar_t *CkFtp2W_asyncLog(HCkFtp2W cHandle);
unsigned long CkFtp2W_getAsyncPercentDone(HCkFtp2W cHandle);
...
int CkFtp2W_getNumFilesAndDirs(HCkFtp2W cHandle);
...
BOOL CkFtp2W_AppendFileFromBinaryData(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkByteData content);
...
BOOL CkFtp2W_CreatePlan(HCkFtp2W cHandle, const wchar_t *localDir, HCkString outStr);
...
BOOL CkFtp2W_DetermineSettings(HCkFtp2W cHandle, HCkString outXmlReport);
const wchar_t *CkFtp2W_determineSettings(HCkFtp2W cHandle);
BOOL CkFtp2W_DirTreeXml(HCkFtp2W cHandle, HCkString outStrXml);
...
BOOL CkFtp2W_Feat(HCkFtp2W cHandle, HCkString outStr);
...
BOOL CkFtp2W_GetCreateTime(HCkFtp2W cHandle, int index, SYSTEMTIME *outSysTime);
BOOL CkFtp2W_GetCreateTimeByName(HCkFtp2W cHandle, const wchar_t *filename, SYSTEMTIME *outSysTime);
BOOL CkFtp2W_GetCreateTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename, HCkString outStr);
const wchar_t *CkFtp2W_getCreateTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename);
BOOL CkFtp2W_GetCreateTimeStr(HCkFtp2W cHandle, int index, HCkString outStr);
const wchar_t *CkFtp2W_getCreateTimeStr(HCkFtp2W cHandle, int index);
BOOL CkFtp2W_GetCurrentRemoteDir(HCkFtp2W cHandle, HCkString outStr);
...
BOOL CkFtp2W_GetFilename(HCkFtp2W cHandle, int index, HCkString outStr);
...
BOOL CkFtp2W_GetLastAccessTime(HCkFtp2W cHandle, int index, SYSTEMTIME *outSysTime);
BOOL CkFtp2W_GetLastAccessTimeByName(HCkFtp2W cHandle, const wchar_t *filename, SYSTEMTIME *outSysTime);
BOOL CkFtp2W_GetLastAccessTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename, HCkString outStr);
const wchar_t *CkFtp2W_getLastAccessTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename);
BOOL CkFtp2W_GetLastAccessTimeStr(HCkFtp2W cHandle, int index, HCkString outStr);
...
BOOL CkFtp2W_GetLastModifiedTime(HCkFtp2W cHandle, int index, SYSTEMTIME *outSysTime);
BOOL CkFtp2W_GetLastModifiedTimeByName(HCkFtp2W cHandle, const wchar_t *filename, SYSTEMTIME *outSysTime);
BOOL CkFtp2W_GetLastModifiedTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename, HCkString outStr);
const wchar_t *CkFtp2W_getLastModifiedTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename);
BOOL CkFtp2W_GetLastModifiedTimeStr(HCkFtp2W cHandle, int index, HCkString outStr);
const wchar_t *CkFtp2W_getLastModifiedTimeStr(HCkFtp2W cHandle, int index);
BOOL CkFtp2W_GetRemoteFileBinaryData(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkByteData outData);
BOOL CkFtp2W_GetRemoteFileTextC(HCkFtp2W cHandle, const wchar_t *remoteFilename, const wchar_t *charset, HCkString outStr);
const wchar_t *CkFtp2W_getRemoteFileTextC(HCkFtp2W cHandle, const wchar_t *remoteFilename, const wchar_t *charset);
BOOL CkFtp2W_GetRemoteFileTextData(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkString outStr);
...
BOOL CkFtp2W_GetSizeStr(HCkFtp2W cHandle, int index, HCkString outStr);
const wchar_t *CkFtp2W_getSizeStr(HCkFtp2W cHandle, int index);
BOOL CkFtp2W_GetSizeStrByName(HCkFtp2W cHandle, const wchar_t *filename, HCkString outStr);
...
BOOL CkFtp2W_GetTextDirListing(HCkFtp2W cHandle, const wchar_t *pattern, HCkString outStrRawListing);
const wchar_t *CkFtp2W_getTextDirListing(HCkFtp2W cHandle, const wchar_t *pattern);
BOOL CkFtp2W_GetXmlDirListing(HCkFtp2W cHandle, const wchar_t *pattern, HCkString outStrXmlListing);
...
BOOL CkFtp2W_NlstXml(HCkFtp2W cHandle, const wchar_t *remoteDirPattern, HCkString outStr);
...
BOOL CkFtp2W_PutFileFromBinaryData(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkByteData content);
...
BOOL CkFtp2W_SendCommand(HCkFtp2W cHandle, const wchar_t *cmd, HCkString outReply);
...
BOOL CkFtp2W_SetRemoteFileDateTime(HCkFtp2W cHandle, SYSTEMTIME *dt, const wchar_t *remoteFilename);
...
BOOL CkFtp2W_Stat(HCkFtp2W cHandle, HCkString outStr);
const wchar_t *CkFtp2W_ck_stat(HCkFtp2W cHandle);
...
BOOL CkFtp2W_Syst(HCkFtp2W cHandle, HCkString outStr);
