...
{
	MyListCtrl1 *pList = (MyListCtrl1*)lParam;
...
BOOL MyListCtrl1::SetHeadings( UINT uiStringID )
{
	CString strHeadings;
...
BOOL MyListCtrl1::SetHeadings( const CString& strHeadings )
{
	int iStart = 0;
...
int MyListCtrl1::AddItem( LPCTSTR pszText, ... )
{
...
void MyListCtrl1::FreeItemMemory( const int iItem )
{
...
BOOL MyListCtrl1::DeleteItem( int iItem )
{
...
BOOL MyListCtrl1::DeleteAllItems()
{
...
int CALLBACK MyListCtrl1::CompareFunction( LPARAM lParam1, LPARAM lParam2, LPARAM lParamData )
{
	MyListCtrl1* pListCtrl = reinterpret_cast<MyListCtrl1*>( lParamData );
...
void MyListCtrl1::OnColumnClick( NMHDR* pNMHDR, LRESULT* pResult )
{
...
void MyListCtrl1::Sort( int iColumn, BOOL bAscending )
{
...
void MyListCtrl1::LoadColumnInfo()
{
...
void MyListCtrl1::SaveColumnInfo()
{
	ASSERT( m_iNumColumns > 0 );
...
BOOL MyListCtrl1::SetItemText( int nItem, int nSubItem, LPCTSTR lpszText )
{
...
BOOL MyListCtrl1::SetItemData( int nItem, DWORD dwData )
{
...
DWORD MyListCtrl1::GetItemData( int nItem ) const
{
...
BOOL MyListCtrl1::SetArray( int iItem, LPTSTR* arrpsz,COLORREF * clrText,COLORREF * clrBak )
{
...
LPTSTR* MyListCtrl1::GetTextArray( int iItem ) const
{
...
void MyListCtrl1::OnCustomDraw(NMHDR* pNMHDR, LRESULT* pResult)
{
...
int MyListCtrl1::AddItemColor(LPCTSTR pszText, COLORREF crText, COLORREF crBak)
{
...
int MyListCtrl1::GetColumns()
{
	return m_ctlHeader.GetItemCount();

}

BOOL MyListCtrl1::GetSubItemRect(int nItem, int nSubItem, int nArea, CRect &rect)
{
...
void MyListCtrl1::DrawText(int nItem, int nSubItem, CDC *pDC, COLORREF crText, COLORREF crBkgnd, CRect &rect)
{
	ASSERT(pDC);
...
void MyListCtrl1::OnSysColorChange() 
{
...
void MyListCtrl1::SetItemColor(int nItem, int nSubItem, COLORREF clrText, COLORREF clrBkgnd)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
void MyListCtrl1::UpdateSubItem(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
				ASSERT(nItem < GetItemCount());
				if ((nItem < 0) || nItem >= GetItemCount())
