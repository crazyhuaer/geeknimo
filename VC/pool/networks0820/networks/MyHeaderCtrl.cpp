...
BEGIN_MESSAGE_MAP(MyHeaderCtrl, CHeaderCtrl)
	//{{AFX_MSG_MAP(MyHeaderCtrl)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// MyHeaderCtrl message handlers
void MyHeaderCtrl::SetSortArrow( const int iSortColumn, const BOOL bSortAscending )
{
...
void MyHeaderCtrl::Serialize( CArchive& ar )
{
	if( ar.IsStoring() )
	{
