...
unsigned long CkFtp2_getAsyncPercentDone(HCkFtp2 cHandle);
...
void CkFtp2_getCommandCharset(HCkFtp2 cHandle, HCkString retval);
void CkFtp2_putCommandCharset(HCkFtp2 cHandle, const char *newVal);
const char *CkFtp2_commandCharset(HCkFtp2 cHandle);
...
int CkFtp2_getDownloadTransferRate(HCkFtp2 cHandle);
...
BOOL CkFtp2_getPreferIpv6(HCkFtp2 cHandle);
void CkFtp2_putPreferIpv6(HCkFtp2 cHandle, BOOL newVal);
...
void CkFtp2_getSyncMustMatch(HCkFtp2 cHandle, HCkString retval);
void CkFtp2_putSyncMustMatch(HCkFtp2 cHandle, const char *newVal);
const char *CkFtp2_syncMustMatch(HCkFtp2 cHandle);
void CkFtp2_getSyncMustNotMatch(HCkFtp2 cHandle, HCkString retval);
void CkFtp2_putSyncMustNotMatch(HCkFtp2 cHandle, const char *newVal);
const char *CkFtp2_syncMustNotMatch(HCkFtp2 cHandle);
void CkFtp2_getSyncPreview(HCkFtp2 cHandle, HCkString retval);
const char *CkFtp2_syncPreview(HCkFtp2 cHandle);
int CkFtp2_getUploadTransferRate(HCkFtp2 cHandle);
...
BOOL CkFtp2_AppendFile(HCkFtp2 cHandle, const char *localFilePath, const char *remoteFilePath);
BOOL CkFtp2_AppendFileFromBinaryData(HCkFtp2 cHandle, const char *remoteFilename, HCkByteData content);
...
BOOL CkFtp2_ChangeRemoteDir(HCkFtp2 cHandle, const char *remoteDirPath);
...
BOOL CkFtp2_CreateRemoteDir(HCkFtp2 cHandle, const char *remoteDirPath);
int CkFtp2_DeleteMatching(HCkFtp2 cHandle, const char *remotePattern);
BOOL CkFtp2_DeleteRemoteFile(HCkFtp2 cHandle, const char *remoteFilePath);
...
BOOL CkFtp2_GetFile(HCkFtp2 cHandle, const char *remoteFilePath, const char *localFilePath);
...
int CkFtp2_GetSizeByName(HCkFtp2 cHandle, const char *filename);
...
BOOL CkFtp2_NlstXml(HCkFtp2 cHandle, const char *remoteDirPattern, HCkString outStr);
const char *CkFtp2_nlstXml(HCkFtp2 cHandle, const char *remoteDirPattern);
BOOL CkFtp2_Noop(HCkFtp2 cHandle);
BOOL CkFtp2_PutFile(HCkFtp2 cHandle, const char *localFilePath, const char *remoteFilePath);
BOOL CkFtp2_PutFileFromBinaryData(HCkFtp2 cHandle, const char *remoteFilename, HCkByteData content);
BOOL CkFtp2_PutFileFromTextData(HCkFtp2 cHandle, const char *remoteFilename, const char *textData, const char *charset);
BOOL CkFtp2_PutPlan(HCkFtp2 cHandle, const char *plan, const char *alreadyDoneFilename);
BOOL CkFtp2_PutTree(HCkFtp2 cHandle, const char *localDir);
BOOL CkFtp2_Quote(HCkFtp2 cHandle, const char *cmd);
BOOL CkFtp2_RemoveRemoteDir(HCkFtp2 cHandle, const char *remoteDirPath);
BOOL CkFtp2_RenameRemoteFile(HCkFtp2 cHandle, const char *existingRemoteFilePath, const char *newRemoteFilePath);
...
void CkFtp2_SetSslCertRequirement(HCkFtp2 cHandle, const char *reqName, const char *reqValue);
...
BOOL CkFtp2_SetSslClientCertPfx(HCkFtp2 cHandle, const char *pfxFilename, const char *pfxPassword);
BOOL CkFtp2_SetTypeAscii(HCkFtp2 cHandle);
BOOL CkFtp2_SetTypeBinary(HCkFtp2 cHandle);
BOOL CkFtp2_Site(HCkFtp2 cHandle, const char *siteCommand);
...
BOOL CkFtp2_SyncRemoteTree2(HCkFtp2 cHandle, const char *localDirPath, int mode, BOOL bDescend, BOOL bPreviewOnly);
BOOL CkFtp2_Syst(HCkFtp2 cHandle, HCkString outStr);
const char *CkFtp2_syst(HCkFtp2 cHandle);
BOOL CkFtp2_UnlockComponent(HCkFtp2 cHandle, const char *unlockCode);
#endif
