...
HCkMailManW CkMailManW_Create2(BOOL bCallbackOwned);
...
void CkMailManW_getLastSendQFilename(HCkMailManW cHandle, HCkString retval);
const wchar_t *CkMailManW_lastSendQFilename(HCkMailManW cHandle);
...
BOOL CkMailManW_FetchMime(HCkMailManW cHandle, const wchar_t *uidl, HCkByteData outData);
BOOL CkMailManW_FetchMimeByMsgnum(HCkMailManW cHandle, int msgnum, HCkByteData outBytes);
...
BOOL CkMailManW_GetMailboxInfoXml(HCkMailManW cHandle, HCkString outXml);
...
HCkStringArrayW CkMailManW_GetSentToEmailAddrs(HCkMailManW cHandle);
...
BOOL CkMailManW_MxLookup(HCkMailManW cHandle, const wchar_t *emailAddress, HCkString outStrHostname);
#endif
#if defined(CK_MX_INCLUDED)
...
BOOL CkMailManW_Pop3SendRawCommand(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset, HCkString outStr);
...
BOOL CkMailManW_RenderToMime(HCkMailManW cHandle, HCkEmailW email, HCkString outStr);
const wchar_t *CkMailManW_renderToMime(HCkMailManW cHandle, HCkEmailW email);
BOOL CkMailManW_RenderToMimeBytes(HCkMailManW cHandle, HCkEmailW email, HCkByteData outBytes);
...
BOOL CkMailManW_SendMimeBytesQ(HCkMailManW cHandle, const wchar_t *from, const wchar_t *recipients, HCkByteData mimeData);
#endif
#if defined(CK_SMTPQ_INCLUDED)
BOOL CkMailManW_SendMimeQ(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients, const wchar_t *mimeSource);
#endif
...
#endif
BOOL CkMailManW_SendToDistributionList(HCkMailManW cHandle, HCkEmailW emailObj, HCkStringArrayW recipientList);
...
BOOL CkMailManW_SetSslClientCertPfx(HCkMailManW cHandle, const wchar_t *pfxFilename, const wchar_t *pfxPassword);
BOOL CkMailManW_SmtpNoop(HCkMailManW cHandle);
BOOL CkMailManW_SmtpReset(HCkMailManW cHandle);
BOOL CkMailManW_SmtpSendRawCommand(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset, BOOL bEncodeBase64, HCkString outStr);
...
BOOL CkMailManW_SshAuthenticatePk(HCkMailManW cHandle, BOOL bSmtp, const wchar_t *sshUsername, HCkSshKeyW sshPrivateKey);
...
BOOL CkMailManW_SshTunnel(HCkMailManW cHandle, BOOL bSmtp, const wchar_t *sshServerHostname, int sshPort);
