...
BOOL CkXmlW_AccumulateTagContent(HCkXmlW cHandle, const wchar_t *tag, const wchar_t *skipTags, HCkString outStr);
...
BOOL CkXmlW_ChilkatPath(HCkXmlW cHandle, const wchar_t *pathCmd, HCkString outStr);
...
BOOL CkXmlW_DecodeContent(HCkXmlW cHandle, HCkByteData outData);
BOOL CkXmlW_DecodeEntities(HCkXmlW cHandle, const wchar_t *str, HCkString outStr);
...
BOOL CkXmlW_GetAttrValue(HCkXmlW cHandle, const wchar_t *name, HCkString outStr);
...
BOOL CkXmlW_GetAttributeName(HCkXmlW cHandle, int index, HCkString outStr);
const wchar_t *CkXmlW_getAttributeName(HCkXmlW cHandle, int index);
BOOL CkXmlW_GetAttributeValue(HCkXmlW cHandle, int index, HCkString outStr);
...
BOOL CkXmlW_GetBinaryContent(HCkXmlW cHandle, BOOL unzipFlag, BOOL decryptFlag, const wchar_t *password, HCkByteData outData);
...
BOOL CkXmlW_GetChildContent(HCkXmlW cHandle, const wchar_t *tag, HCkString outStr);
const wchar_t *CkXmlW_getChildContent(HCkXmlW cHandle, const wchar_t *tag);
BOOL CkXmlW_GetChildContentByIndex(HCkXmlW cHandle, int index, HCkString outStr);
...
BOOL CkXmlW_GetChildTag(HCkXmlW cHandle, int index, HCkString outStr);
const wchar_t *CkXmlW_getChildTag(HCkXmlW cHandle, int index);
BOOL CkXmlW_GetChildTagByIndex(HCkXmlW cHandle, int index, HCkString outStr);
...
BOOL CkXmlW_GetXml(HCkXmlW cHandle, HCkString outStr);
...
BOOL CkXmlW_TagContent(HCkXmlW cHandle, const wchar_t *tagName, HCkString outStr);
