...
m_tt.Activate(TRUE);    //添加
 m_tt.AddTool(GetDlgItem(IDC_BUTTON_REFRESH),"这是一个按钮");  //添加++-----IDC_BUTTON1是需要进行提示的按钮的ID值，这个函数的原型是 BOOL AddTool( CWnd* pWnd, LPCTSTR lpszText = LPSTR_TEXTCALLBACK, LPCRECT lpRectTool = NULL, UINT_PTR nIDTool = 0 );
m_tt.SetTipTextColor(RGB(0,0,255)); //提示文字颜色，非必需-----添加++          
m_tt.SetDelayTime(150);    //出现提示前的延迟时间，非必需 ----添加++
	//////////////////////////////////////////////////////////////////////////
