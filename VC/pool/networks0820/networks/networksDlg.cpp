	...
	case 4:
			...
			(atof(ICA[10]) > 2.5) || (atof(ICA[10]) < 2.6) || (atof(ICA[11]) > 2.5) || (atof(ICA[11]) > 2.6))*/
		{
			...
			if ((atof(ICA[0]) > 2.8) || (atof(ICA[0]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 1, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[1]) > 2.8) || (atof(ICA[1]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 2, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[2]) > 2.8) || (atof(ICA[2]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 3, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[3]) > 2.8) || (atof(ICA[3]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 4, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[4]) > 2.8) || (atof(ICA[4]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 5, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[5]) > 2.8) || (atof(ICA[5]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 6, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[6]) > 2.8) || (atof(ICA[6]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 7, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[7]) > 2.8) || (atof(ICA[7]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 8, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[8]) > 2.8) || (atof(ICA[8]) < 2.4))
				m_UnknowType.m_List_UnknowType.SetItemColor(m_UnknowType.m_line, 9, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[9]) > 2.8) || (atof(ICA[9]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 10, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[10]) > 2.8) || (atof(ICA[10]) < 2.4))
				m_UnknowType.m_List_UnknowType.SetItemColor(m_UnknowType.m_line, 11, RGB(255,0,0), RGB(255,255,255));
			if ((atof(ICA[11]) > 2.8) || (atof(ICA[11]) < 2.4))
				m_SZLTC30M.m_List_szLTC30M.SetItemColor(m_UnknowType.m_line, 12, RGB(255,0,0), RGB(255,255,255));
