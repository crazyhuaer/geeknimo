...
#if defined(CK_WINDOWS) && !defined(WINCE) && !defined(CK_LIBWINPHONE)
#define CK_SMTPQ_INCLUDED
#endif

// Determine if the SFX (Self-extracting EXE) functionality is included.
#if defined(CK_WINDOWS) && !defined(WINCE) && !defined(CK_LIBWINPHONE) && !defined(LINKAGE_TESTING)
#define CK_SFX_INCLUDED
#endif

// Determine if Windows-based Cryptographic Service Provider (CSP) functionality is available
#if defined(CK_WINDOWS) && !defined(CK_LIBWINPHONE) && !defined(__MINGW32__)
...
#if defined(CK_WINDOWS) && !defined(__MINGW32__) && !defined(CK_LIBWINPHONE)
...
#if !defined(WINCE) && !defined(__MINGW32__) && !defined(CK_LIBWINPHONE)
