...
BOOL CkMimeW_AsnBodyToXml(HCkMimeW cHandle, HCkString outStr);
...
BOOL CkMimeW_GetBodyBinary(HCkMimeW cHandle, HCkByteData outData);
BOOL CkMimeW_GetBodyDecoded(HCkMimeW cHandle, HCkString outStr);
const wchar_t *CkMimeW_getBodyDecoded(HCkMimeW cHandle);
BOOL CkMimeW_GetBodyEncoded(HCkMimeW cHandle, HCkString outStr);
const wchar_t *CkMimeW_getBodyEncoded(HCkMimeW cHandle);
HCkCertW CkMimeW_GetEncryptCert(HCkMimeW cHandle, int index);
BOOL CkMimeW_GetEntireBody(HCkMimeW cHandle, HCkString outStr);
const wchar_t *CkMimeW_getEntireBody(HCkMimeW cHandle);
BOOL CkMimeW_GetEntireHead(HCkMimeW cHandle, HCkString outStr);
const wchar_t *CkMimeW_getEntireHead(HCkMimeW cHandle);
BOOL CkMimeW_GetHeaderField(HCkMimeW cHandle, const wchar_t *fieldName, HCkString outStr);
const wchar_t *CkMimeW_getHeaderField(HCkMimeW cHandle, const wchar_t *fieldName);
BOOL CkMimeW_GetHeaderFieldAttribute(HCkMimeW cHandle, const wchar_t *name, const wchar_t *attrName, HCkString outStr);
const wchar_t *CkMimeW_getHeaderFieldAttribute(HCkMimeW cHandle, const wchar_t *name, const wchar_t *attrName);
BOOL CkMimeW_GetHeaderFieldName(HCkMimeW cHandle, int index, HCkString outStr);
const wchar_t *CkMimeW_getHeaderFieldName(HCkMimeW cHandle, int index);
BOOL CkMimeW_GetHeaderFieldValue(HCkMimeW cHandle, int index, HCkString outStr);
const wchar_t *CkMimeW_getHeaderFieldValue(HCkMimeW cHandle, int index);
BOOL CkMimeW_GetMime(HCkMimeW cHandle, HCkString outStr);
const wchar_t *CkMimeW_getMime(HCkMimeW cHandle);
BOOL CkMimeW_GetMimeBytes(HCkMimeW cHandle, HCkByteData outBytes);
...
BOOL CkMimeW_GetSignatureSigningTimeStr(HCkMimeW cHandle, int index, HCkString outStr);
...
BOOL CkMimeW_GetXml(HCkMimeW cHandle, HCkString outStr);
...
void CkMimeW_RemoveHeaderField(HCkMimeW cHandle, const wchar_t *fieldName, BOOL bAllOccurances);
